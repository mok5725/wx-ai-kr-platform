...
export const CHAPTERS = [
  ...
  },
  {
    ...
    slides: [
      ...
      { id: 'board', title: '팀 빌딩 보드 — 우리 팀을 한 장에 적습니다',
        note: '앞 장에서 할 일 셋을 말했으면 바로 이 장을 띄워 두고 팀 빌딩을 진행한다. 화면은 다 채운 예시이고, 크루는 같은 칸을 자기 팀 것으로 채운다. 왼쪽 장은 이름을 옮겨 적으면 끝나므로 5분 안에 닫고 나머지 시간을 오른쪽 장(과제명·의미·규칙)에 쓰게 한다. 코치 칸의 이름은 농담이다 — 실제 코치는 4-3에 있다.' },
    ],
  },
  {
    id: 'devprep',
