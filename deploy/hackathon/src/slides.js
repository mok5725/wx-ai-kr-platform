...
export const CHAPTERS = [
  {
    ...
    slides: [
      ...
      { id: 'selected', title: '여러분은 마스터 크루입니다',
        note: '첫 대면 자리다. 이 장에서 환영사 큐를 넘긴다. 115명 지원에 22명 선발 — 5.2:1이다. 운영 자료의 "15~20명"은 확정 전 계획치이고, 최종 확정 명단이 22명이다.' },
  ...
  },
  {
    ...
    slides: [
      { id: 'what-is', title: 'WX해커톤은 어떤 대회인가요',
        note: '3회차라는 점, 올해 처음 투 트랙으로 나뉘었다는 점만 짚고 넘어간다. 길게 끌지 않는다. 경쟁률을 묻거든 — 24년 6.9:1, 25년 1.9:1, 26년 챌린저 6.8:1, 마스터 5.2:1. 25년은 해커톤과 제로톤 둘 다 열렸고 화면에 나란히 있다.' },
  ...
  },
  {
    ...
    title: '함께하는 사람들',
    slides: [
      { id: 'sponsors', title: '오늘 함께해 주신 스폰서',
        note: '스폰서 4인 인사 순서. 스폰서는 오늘 하루 참관이 아니라 9월까지 리소스를 대는 사람이라는 점을 짚는다. 인사가 끝나면 다음 장에서 김경철 센터장 환영사로 넘긴다 — 센터장은 스폰서이면서 환영사를 함께 맡는다.' },
      { id: 'welcome', title: '환영사 — 김경철 센터장',
        note: '이 장을 띄운 채로 센터장에게 마이크를 넘기고, 말씀이 끝나면 다음 장으로 간다. 화면에는 사진과 소속만 있다 — 말씀은 센터장이 직접 하신다.' },
      { id: 'expedition', title: '인창원 해커톤 원정대를 소개합니다',
        note: '아이스브레이킹 구간. 얼굴이 크게 뜨므로 한 명씩 눈을 맞추며 별칭의 유래를 짧게 붙이면 웃음이 나온다. 오늘 진행 담당(노영은 과장·이종은 차장)이 누구인지 여기서 확실히 알린다.' },
      { id: 'support', title: '혼자 만들지 않습니다',
        note: '크루가 혼자 짊어지는 구조가 아니라는 것이 핵심 메시지. 미래연 자문은 주 1~2회, 팀스파르타 코치는 상시라는 점을 구분해서 말한다.' },
      { id: 'roles-make', title: '역할분담 — 과제를 만드는 사람들',
        note: '앞 장의 조직도를 사람 단위로 푼 장이다. 칩을 다 읽지 말고 "여러분이 Core입니다"만 짚는다. 미래연 자문과 팀스파르타 코치는 이름과 한 줄 역할만 소개하고 넘어간다 — 상세는 크루가 화면에서 읽는다.' },
      { id: 'roles-back', title: '역할분담 — 그 팀을 받치는 사람들',
        note: '실사용자와 사내 기술 지원이 크루 밖에서 붙는 사람이라는 점을 짚는다. 저장소 안내(Gitlab·Agentee)는 개발 준비 챕터에서 다시 나오므로 여기서는 협조요청이 끝났다는 것만 말한다.' },
    ],
  },
  {
    id: 'tasks',
  ...
  },
  {
    ...
    title: '혜택과 평가',
    slides: [
      { id: 'perks', title: '완주한 크루에게 드리는 혜택',
        note: '과제 세 장을 본 직후다. "이걸 완주하면 무엇이 남는가"로 이어 붙는 자리라 과제 챕터 바로 뒤에 둔다. 여기서 분위기를 한 번 올리고 개발 준비로 넘어간다.' },
      { id: 'evaluation', title: '솔루션 평가 — 2 Track',
        note: '본선에서 무엇으로 평가받는지 미리 알려주는 장이다. 두 평가를 모두 받는다는 점, 그리고 Verification은 본부장급·Validation은 실장급 임원이 들어온다는 점을 짚는다. 이 2 Track 구성은 센터장 의견으로 정해졌다.' },
    ],
  },
  {
    id: 'devprep',
